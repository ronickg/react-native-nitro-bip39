...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<WordLists> final {
    static inline WordLists fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        ...
        default: [[unlikely]]
          throw std::invalid_argument("Cannot convert \"" + unionValue + "\" to enum WordLists - invalid value!");
      }
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, WordLists arg) {
      switch (arg) {
        ...
        default: [[unlikely]]
          throw std::invalid_argument("Cannot convert WordLists to JS - invalid value: "
